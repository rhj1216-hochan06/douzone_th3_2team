...
<body>
	...
	<div class="content">
		...
		<div class="contentBottom">
			...
			<br><br><br>
			<a href="javascript:location.href='member?cmd=AdminMemberSelect'"><img src="${path}/views/img/IconMemberSelect.png" alt="회원 조회" style="width: 150px; height: 150px"><span>회원 조회</span></a>	
			<a href="javascript:location.href='member?cmd=AdminOrderSelect'"><img src="${path}/views/img/IconOrderSelect.png" alt="주문 조회" style="width: 150px; height: 150px"><span>주문 조회</span></a>	
			<a href="javascript:location.href='member?cmd=AdminQnA'"><img src="${path}/views/img/IconQnA.png" alt="QnA 확인" style="width: 150px; height: 150px"><span>QnA 확인</span></a>
			<a href="javascript:location.href='member?cmd=AdminStock'"><img src="${path}/views/img/IconStock.png" alt="재고 현황" style="width: 150px; height: 150px"><span>재고 현황</span></a>
			<br><br>
		</div>
