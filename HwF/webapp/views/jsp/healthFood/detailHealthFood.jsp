...
<body>
	...
	<form name="buybottle" action="${path}/cart?cmd=healthFoodInsertCart"
		method="post">
		...
		<div id="nutrientsListDiv">
			...
			<c:forEach var="healthFoodList" items="${ healthFoodList }">
				...
				<div id="nutrdiscription">
					...
					<div>
					<input type="text" id="hiddenid" name="hfid" value="${ healthFoodList.hfid }" />
					...
					<div>
						<br />
						<div>제조날짜 : ${ healthFoodList.hfDoM }</div>
						<br />
