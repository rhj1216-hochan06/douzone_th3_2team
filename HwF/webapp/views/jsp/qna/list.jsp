			...
			<form action="Member?cmd=membersearchboard" method="post">
				<div class="columnClass">
					...
					<a id="cl" title="Button border lightblue"
						class="button btnFloat btnLightBlue" href="./views/jsp/qna/writeform.jsp">글쓰기</a>
				</div>
				...
				<table class="qnatable" cellpadding="3">
					...
					<c:forEach var="list" items="${list}">
						...
						<tr>
							...
							<td>${ list.qnatitle }</td>
							<td
								onclick="javascript:location.href='board?cmd=detail&qnaid=${ list.qnaid }' ">${ list.qnacontent }</td>
