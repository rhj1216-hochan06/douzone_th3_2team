	...
	<div id="con">
		<div class="container">
		        <div class="card card-container">
		        	...
		        	<img id="inbodyImg" src="${path}/views/img/IconInbody.png" /> 
		        	
		        	<div id="inbodySubmit">
			           	   <input type="button" value="인바디 등록하러가기" class="btn btn-lg btn-primary btn-block btn-signin" 
			           	   onclick="location.href='Member?cmd=inbody'">
			        </div>
			            
			            <h2 align="center">인바디 내역</h2><br>
						   ...
						   <table style="margin-left: auto; margin-right:auto;">
						      ...
						      <tbody>
								<c:forEach var="InbodyserachAll" items="${ InbodyserachAll}">
									...
									<form action="Member?cmd=inbodyDelete" method="post">
									
										<tr>
											<td><input id="inbodyid" name="inbodyid" value="${InbodyserachAll.inbodyid }" readonly></td>
											<td>${InbodyserachAll.memberheight}</td>
											<td>${InbodyserachAll.memberweight}</td>
											<td>${InbodyserachAll.bodymuscle}</td>
											<td>${InbodyserachAll.bodyfat}</td>
											<td>${InbodyserachAll.inbodyresult}</td>
