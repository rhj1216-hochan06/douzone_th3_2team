		...
		<div class="container">
		        <div class="card card-container">
						<form action="./Member?cmd=surveyresult" method="post">
							...
							Q. 당신의 목표는? : 
							<select name="goal">
								<option value="1">근육량 증가</option>
								<option value="2">체지방 감소 (다이어트)</option>
							</select> <br><br>
							
							Q. 일어선 상태로 고개만 숙여 발을 본다면? : 
							<select name="currentstate">
								<option value="1">배만 보인다.</option>
								<option value="2">배에 가려져 발이 살짝만 보인다.</option>
								<option value="3">발이 잘 보인다.</option>
							</select> <br><br> 
							
							Q. 삼시세끼 영양소 섭취 수준은? : 
							<select name="currentintke">
								<option value="1">항상 배부르게 과식한다.</option>
								<option value="2">적당히 배부르게 잘 챙겨 먹는다.</option>
								<option value="3">끼니를 대충 해결하며 영양소를 신경쓰지 않는다.</option>
							</select> <br><br> 
							
							<div id="serveySubmit">
								<input type="submit" value="제출하기" class="btn btn-lg btn-primary btn-block btn-signin" >
							</div>
