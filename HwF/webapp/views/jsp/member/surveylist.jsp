	...
	<div id="con">
		<div class="container">
		        <div class="card card-container">
			            ...
			            <img id="surveyImg" src="${path}/views/img/IconSurvey.png" /> <br>
			            	
			            <div id="serveySubmit">
			           	   <input type="button" value="설문조사 하러가기" class="btn btn-lg btn-primary btn-block btn-signin" 
						   ...
						   <table style="margin-left: auto; margin-right:auto;">
						      ...
						      <tbody>
						         <c:forEach var="SurveyserachAll" items="${ SurveyserachAll}">
						           ...
						           <form action="Member?cmd=surveyDelete" method="post">
						               
						               <tr>
						                  <td><input id="surveyid" name="surveyid" value="${SurveyserachAll.surveyid }" readonly></td>
