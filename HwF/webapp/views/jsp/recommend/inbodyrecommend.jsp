...
<title>inbodyrecommend.jsp</title>
</head>
<body>
	...
	<table>
		...
		<tbody>
			...
			<c:forEach var="HealthGoodsSelect" items="${ HealthGoodsSelect }">
				<tr id="${HealthGoodsSelect.healthGoodsId}" title="${HealthGoodsSelect.healthGoodsName}의 상세 페이지 가기"
	...
	<table>
		...
		<tbody>
			<c:forEach var="HealthFoodSelect" items="${ HealthFoodSelect }">
				<tr id="${HealthFoodSelect.hfid}" title="${HealthFoodSelect.hfname}의 상세 페이지 가기"
	...
	<table>
		...
		<tbody>
			<c:forEach var="NutrientsSelect" items="${ NutrientsSelect }">
				<tr id="${NutrientsSelect.nutrientsID}" title="${NutrientsSelect.nutrientsName}의 상세 페이지 가기"
