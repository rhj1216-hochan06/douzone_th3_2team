		...
		<nav>
			...
			<table>
				<tr>
					...
					<td id="7"
						onclick="location.href='../../../Member?cmd=membersearch'">Community</td>
				</tr>
			</table>
		</nav>
	</header>
		...
		<div class="info">
			<ul>
				...
				<div>② 사업자는 체력단련장 이용신청을 승낙할 경우 이용자에게 이용증과 약식 약관(이용증 이면에 첨부)을
					교부하여야 합니다.</div>
				<div>③ 사업자는 제2항의 약식약관의 교부에 관계없이 이용자가 요구할 경우 약관의 사본을 교부하여야 합니다.</div>
				<div>제4조(게시․설명의무)</div>
				...
				<div>② 이용자는 이용증을 분실하였을 경우 지체없이 사업자에게 그 사실을 통지 하고 재교부를 받아야 합니다.</div>
				<div>제6조(이용신청 철회)</div>
				...
				<div>② 계약을 해제․해지하는 경우 사업자와 이용자는 다음과 같은 조건으로 계약을 해제․해지할 수 있습니다.
				</div>
				<div>[이용개시일 이전 계약 해제․해지]</div>
				<div>1. 제1항 각 호의 사유로 인하여 이용자가 계약을 해제․해지하는 경우 사업자는 총 이용금액(‘매 이용
					계약시 이용료로 납입한 총액’으로 이하 같음) 전액과 총 이용금액의 10%에 해당하는 금액을 이용자에게 환불합니다.</div>
				<div>2. 이용자 사정으로 계약을 해제․해지하는 경우 사업자는 총 이용금액의 10%에 해당하는 금액을 공제한
					후 이용자에게 환불합니다.</div>
				...
				<div>⑥ 제5항에 의해 이용자가 보관을 의뢰하지 않은 고가물이 멸실 또는 훼손된 경우 사업자는 제4항에 의거
					손해배상 책임을 집니다.</div>
				...
				<div>제13조(기타)</div>
				<div>① 이 약관에서 규정하지 않은 사항은 관계법령 및 거래 관행을 고려하여 신의칙에 따라 사업자와 이용자가
					합의하여 해결합니다.</div>
		...
		<div class="heatlhpolicy">
			<ul>
				...
				<div>② “이용자”란 “몰”에 접속하여 이 약관에 따라 “회사”가 제공하는 서비스를 받는 회원 및 비회원을
					말합니다.</div>
				<div>③ “회원”이라 함은 “몰”에 회원 가입을 한 자로서, 계속적으로 “몰”이 제공하는 서비스를 이용할 수
					있는 자를 말합니다.</div>
				...
				<div>① “회사”는 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수
					...
					“이용자”가 쉽게 알 수 있도록 ”몰”의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 “이용자”가
					연결화면을 통하여 볼 수 있도록 할 수 있습니다.</div>
				...
				<div>③ “회사”는 「전자상거래 등에서의 소비자보호에 관한 법률」, 「약관의 규제에 관한 법률」, 「전자문서
					및 전자거래기본법」, 「전자금융거래법」, 「전자서명법」, 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」, 「방문판매
					등에 관한 법률」, 「소비자기본법」 등 관련 법을 위배하지 않는 범위에서 이 약관을 개정할 수 있습니다.</div>
				<div>④ “회사”는 이 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 “몰”의
					초기화면에 그 적용일자 7일 이전부터 적용일자 전일까지 공지하고 “이용자”에게 통지합니다. 다만, “이용자”에게 불리하게
					약관내용을 변경하는 경우에는 최소한 30일 이상의 사전 유예기간을 두고 공지 및 통지합니다. 이 경우 "회사“는 개정 전
					내용과 개정 후 내용을 명확하게 비교하여 “이용자”가 알기 쉽도록 표시합니다.</div>
				<div>⑤ “이용자”는 개정 약관이 게시되거나 통지된 후부터 변경되는 약관의 시행일 전의 영업일까지 개정 전
					약관조항에 따라 체결된 계약을 해지할 수 있고, 약관의 개정내용에 대하여 이의를 제기하지 아니하는 경우에는 약관의 개정을
					승인한 것으로 봅니다.</div>
				...
				<div>② “회사”는 재화 등의 품절 또는 기술적 사양의 변경 등의 경우에는 장차 체결되는 계약에 의해 제공할
					재화 등의 내용을 변경할 수 있습니다. 이 경우에는 변경된 재화 또는 용역의 내용 및 제공일자를 명시하여 현재의 재화
					등의 내용을 게시한 곳에 즉시 공지합니다.</div>
				...
				<p></p>
				<div>제6조(회원가입)</div>
				<div>① “이용자”는 “회사”가 정한 가입 양식에 따라 회원정보를 기입한 후 이 약관에 동의한다는 의사표시를
					함으로서 회원가입을 신청합니다.</div>
				<div>② “회사”는 제1항과 같이 회원으로 가입할 것을 신청한 “이용자” 중 다음 각 호에 해당하지 않는 한
					회원으로 등록합니다.</div>
				...
				<div>2. “몰”을 이용하여 구입한 재화 등의 대금, 기타 “몰” 이용에 관련하여 “회원”이 부담하는 채무를
					기일에 지급하지 않는 경우</div>
				...
				<div>① “회사”는 “회원”에 대한 통지를 하는 경우, 회원이 “회사”와 미리 약정하여 지정한 전자우편
					주소로 할 수 있습니다. “회원”은 자신이 지정한 전자우편 주소에 변경이 생긴 경우 이를 “몰”에서 정한 방법 및 절차에
					따라 이를 수정하여야 하며, “회원”이 이를 게을리하여 “회사”가 원래의 전자우편 주소로 통지를 한 경우 그러한 통지는
					유효하게 도달된 것으로 봅니다.</div>
				<div>② “회사”는 불특정다수 회원에 대한 통지의 경우 1주일 이상 “몰” 게시판에 게시함으로서 개별 통지에
					갈음할 수 있습니다. 다만, 회원 본인의 거래와 관련하여 중대한 영향을 미치는 사항에 대하여는 개별통지를 합니다.</div>
				<p></p>
				<div>제9조(“회사“의 의무)</div>
				<p></p>
				<div>① “회사”는 법령과 이 약관이 금지하거나 공서양속에 반하는 행위를 하지 않으며 이 약관이 정하는 바에
					따라 지속적이고, 안정적으로 재화 등을 제공하는데 최선을 다하여야 합니다.</div>
				...
				<div>“몰”에서 구매한 재화 등의 대금 지급은 다음 각 호의 어느 하나의 방법으로 할 수 있습니다. 단,
					“회사”가 필요로 하는 경우 재화 등의 대금 지급 방법을 각 호의 방법 중 “회사”가 정한 방법으로 결정할 수 있습니다.
					“회사”는 “이용자”의 지급방법에 대하여 재화 등의 대금에 어떠한 명목의 수수료도 추가하여 징수할 수 없습니다.</div>
				...
				<div>③ "회사"는 "000 적립금"의 적립기준, 사용방법, 사용기한 및 제한 등을 상품, 회원등급 및 지급
					사유 등에 따라 다르게 정할 수 있으며, "몰"의 화면에 별도로 게시하거나 통지합니다.</div>
				<div>④ “000 적립금”은 1) 사용기한이 먼저 도래하는 순서 2) 사용기한이 동일한 경우 적립일자가 빠른
					순서대로 사용됩니다.</div>
				...
				<div>⑥ "회원"이 "회사"가 승인하지 않은 방법 또는 허위 정보 제공, 본 약관에 위배되는 등의 부정한
					...
					적립금"의 사용을 제한하거나 “회사”가 정한 방법으로 회수할 수 있으며, "000 적립금"을 사용한 구매신청을 취소하거나
					"회원" 자격을 정지할 수 있습니다.</div>
				...
				<div>3. 약관 내용, 청약철회권이 제한되는 서비스, 배송료․설치비 등의 비용부담과 관련한 내용에 대한 확인
				</div>
				...
				<div>② “회사”는 제1항에 따른 승낙의 의사 표시는 “몰” 내에서 “이용자”에게 제공되는 팝업 기타 안내
					화면, 전자문서 등을 통한 수신확인 통지의 방법으로 하며, 계약의 성립 시기는 수신확인 통지가 “이용자”에게 도달한 때로
					합니다.</div>
				...
				<div>⑤ 계약이 성립한 후 회사가 제6항 각 호의 사유를 발견한 경우 “회사”는 즉시 계약을 해제 또는
					취소할 수 있으며, 계약 해제 또는 취소 시 회사는 회원이 상품 대금을 지급한 날로부터 3영업일 이내에 환급하거나 환급에
					필요한 조치를 취합니다.</div>
				...
				<p></p>
				<div>① “회사”는 ”이용자”가 청약을 한 날부터 7일 이내에 재화 등의 공급에 필요한 조치를 하여야 하고,
					“이용자”가 재화 등을 공급받기 전에 미리 재화 등의 대금을 전부 또는 일부 지급한 경우 “이용자”가 그 대금을 지급한
					날부터 3영업일 이내에 재화 등의 공급에 필요한 조치를 취합니다.</div>
				<div>② “회사”는 “이용자”가 구매한 재화에 대해 배송수단, 수단별 배송비용 부담자, 수단별 배송기간 등을
					안내합니다.</div>
				<p></p>
				<div>제19조(환급)</div>
				<p></p>
				...
				<p></p>
				<div>제20조(청약철회 등)</div>
				<div>① “회사”와 재화 등의 구매에 관한 계약을 체결한 “이용자”는 「전자상거래 등에서의 소비자보호에 관한
					법률」 제13조 제2항에 따른 계약내용에 관한 서면을 받은 날(그 서면을 받은 때보다 재화 등의 공급이 늦게 이루어진
					경우에는 재화 등을 공급받거나 재화 등의 공급이 시작된 날을 말합니다)부터 7일 이내에는 해당 계약에 대한 청약의 철회
					및 계약의 해제(이하 “청약철회 등”)를 할 수 있습니다. 다만, 청약철회 등에 관하여 「전자상거래 등에서의 소비자보호에
					관한 법률」에 달리 정함이 있는 경우에는 동 법 규정에 따릅니다.</div>
				<div>② “이용자”는 다음 각 호의 어느 하나에 해당하는 경우에는 “회사”의 의사에 반하여 청약철회 등을 할
					수 없습니다.</div>
				...
				<div>② “회사”가 제공하는 재화 등이 관할 관청 또는 당국에 의해 제재를 받았을 때 "회사"는 해당 재화
					...
					손해에 대해서 "회사"는 일체의 책임을 지지 않으며 또한 “이용자”는 해당 물품에 대한 서비스 이용요금 및 관련비용 등의
					지급의무를 면하지 아니합니다.</div>
				...
				<P></P>
				<div>① 통신판매중개서비스와 관련하여 “회사”는 통신판매중개자로서 “이용자”와 “판매자” 간의 자유로운 재화
					등의 거래를 위한 시스템을 운영, 관리 및 제공하며 “이용자”는 재화 등을 구매하기 전에 반드시 “판매자”가 “몰” 내에
					작성한 재화 등의 상세 내용과 거래 조건을 확인해야 합니다.</div>
				...
				<div>③ “회사”는 관련 법령에 따라 “회사"가 책임을 부담하는 경우를 제외하고는 “몰”에서의 “판매자”와
					...
					안정성, 적법성 및 타인의 권리에 대한 비침해성, “판매자”가 제공하거나 등록한 정보 및 자료의 진실성 또는 적법성 등을
					보증하지 아니하며, “이용자”와 “판매자” 간의 상품 거래에 관한 위험과 책임은 거래 당사자가 부담합니다.</div>
				<p></p>
				...
				<div>② 청약철회 등에 필요한 배송비 및 기타 비용은 귀책사유가 있는 당사자가 부담합니다. 이 경우 재화
					등의 하자 또는 오배송으로 인한 철약철회 등은 “판매자”가 그 비용을 부담하고, “이용자”의 단순 변심으로 인한 청약철회
					등은 “이용자”가 그 비용을 부담합니다.</div>
				...
				<div>② “이용자”는 “ 몰”을 이용함으로써 얻은 정보 중 “회사”에게 지적재산권이 귀속된 정보를 “회사”의
					사전 승낙 없이 복제, 송신, 출판, 배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나 제3자에게 이용하게 하여서는
					안됩니다.</div>
				<div>③ “이용자”가 “회사”의 서비스를 이용하면서 작성한 상품평, Q＆A 등 게시물의 저작권은 해당
					“이용자” 본인에게 있으며, 해당 게시물이 타인의 저작권 및 기타 지적재산권을 침해하는 경우 그에 대한 책임은 “이용자”
					본인이 부담합니다.</div>
