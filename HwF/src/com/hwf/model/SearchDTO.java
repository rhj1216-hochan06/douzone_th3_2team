...
public class SearchDTO {
	...
	public SearchDTO(String hfname, String hfimg, String hfdetail, String hfdom, int hfid, int heprice, int hecategory,
			String link) {
		super();
		this.hfname = hfname;
		this.hfimg = hfimg;
	...
	public SearchDTO(int nutrientsID, String nutrientsName, int nutrientsPrice, int nutrientsCategory,
