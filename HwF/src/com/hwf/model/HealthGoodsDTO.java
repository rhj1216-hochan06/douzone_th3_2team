...
public class HealthGoodsDTO { // model
	...
	public HealthGoodsDTO(String healthGoodsName, int healthGoodsPrice, String healthGoodsCategory,
			String healthGoodsImg, String healthGoodsDetail, String link) {
		super();
